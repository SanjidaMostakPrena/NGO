...
//   totalPaid: string;
//   totalDue: string;
//   status: 'চলতি ঋণ' | 'বকেয়া ঋণ' | 'পরিশোধিত';
...
//     { id: 'LN-৯২০৫', memberId: 'M-১০৫২', memberName: 'মো: হাসান আলী', initial: 'হা', loanAmount: '৳ ৩০,০০০', disbursedDate: '২০ নভেম্বর, ২০২৫', totalInstallments: 30, paidInstallments: 22, totalPaid: '৳ ২২,০০০', totalDue: '৳ ৮,০০০', status: 'বকেয়া ঋণ', statusType: 'due' },
//     { id: 'LN-১১৮২', memberId: 'M-৭৭১২', memberName: 'সুমাইয়া আক্তার', initial: 'সু', loanAmount: '৳ ২০,০০০', disbursedDate: '০৫ মার্চ, ২০২৫', totalInstallments: 20, paidInstallments: 20, totalPaid: '৳ ২০,০০০', totalDue: '৳ ০', status: 'পরিশোধিত', statusType: 'paid' },
...
//           <p className="text-slate-500 text-sm">সদস্যদের মাঝে বিতরণকৃত মাইক্রো-ক্রেডিট ঋণ, চলমান কিস্তি ট্র্যাকিং এবং বকেয়া আদায় মনিটর প্যানেল।</p>
//         </div>
//         <button 
...
//           <div>
//             <p className="text-slate-400 text-xs font-bold">বকেয়া ঋণের তালিকা</p>
...
//                 <th className="p-4">মোট আদায়কৃত টাকা</th>
//                 <th className="p-4">অবশিষ্ট বকেয়া স্থিতি</th>
...
//                         <button className="hover:text-[#0c2483] transition-colors" title="কালেকশন রসিদ"><Receipt size={14} /></button>
//                         <button className="hover:text-slate-700 transition-colors" title="বিস্তারিত দেখুন"><Eye size={14} /></button>
//                         <button className="hover:text-slate-700 transition-colors"><Edit2 size={14} /></button>
//                       </div>
//                     </td>
              ...
              {filteredLoans.length > 0 ? (
                filteredLoans.map((loan) => (
                  <tr key={loan.id} className="hover:bg-slate-50/40 transition-colors">
                    ...
                    <td className="p-4 text-center">
                      <div className="flex items-center justify-center gap-2.5 text-slate-400">
                        <button onClick={() => handleOpenReceipt(loan)} className="hover:text-[#0c2483] transition-colors" title="কিস্তি আদায় / রসিদ"><Receipt size={14} /></button>
