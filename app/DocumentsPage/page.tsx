...
//     { id: 'DOC-২২৪১', fileName: 'ক্ষুদ্র_ঋণ_চুক্তিপত্র_কেন্দ্র_০৫_স্ট্যাম্প.docx', category: 'ঋণ চুক্তি', fileType: 'DOCX', uploadedBy: 'সুমাইয়া আক্তার', uploadDate: '৩০ মে, ২০২৬', fileSize: '৪.৫ MB', memberId: 'LN-৪৪০২' },
//     { id: 'DOC-৯৮১২', fileName: 'জরুরী_সাধারণ_সভা_রেজুলেশন_২০২৬.pdf', category: 'অফিস নোটিশ', fileType: 'PDF', uploadedBy: 'মো: হাসান আলী', uploadDate: '২৮ মে, ২০২৬', fileSize: '৮৫০ KB' },
...
//     { id: 'DOC-১১৭২', fileName: 'সদস্য_ফাতেমা_বেগম_ভর্তি_ফরম_স্ক্যান.pdf', category: 'সদস্য ফাইল', fileType: 'PDF', uploadedBy: 'সুমাইয়া আক্তার', uploadDate: '২৪ মে, ২০২৬', fileSize: '৩.৮ MB', memberId: 'MB-৭১০৩' },
//   ]);
...
//           <div>
//             <p className="text-slate-400 text-xs font-bold">ওয়ার্ড ফাইল (DOCX)</p>
...
//           <input 
//             type="text" 
//             placeholder="ফাইলের নাম, আইডি বা সদস্য কোড দিয়ে খুঁজুন..."
//             value={searchQuery}
...
//                         <button className="p-1.5 rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-50 hover:text-[#0c2483] transition-all shadow-2xs" title="ডকুমেন্ট ভিউ"><Eye size={13} /></button>
//                         <button className="p-1.5 rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-50 hover:text-emerald-600 transition-all shadow-2xs" title="ডাউনলোড ফাইল"><Download size={13} /></button>
//                         <button 
...
//                     আর্কাইভে কোনো মেম্বার বা অফিসিয়াল আপলোডেড ডকুমেন্ট ফাইল খুঁজে পাওয়া যায়নি।
//                   </td>
//                 </tr>
//               )}
//             </tbody>
...
//                     <option value="DOCX">DOCX ওয়ার্ড ফাইল</option>
//                   </select>
//                 </div>
//               </div>
